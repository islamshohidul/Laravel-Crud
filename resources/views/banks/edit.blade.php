...
@section('content')
    ...
    <div class="container">
        ...
        <div >
            ...
            <form class="form-horizontal" action="{{route('banks.update', $bank->id)}}" method="post">
                {{csrf_field()}}
                {{method_field('PUT')}}
                <div class="form-group">
                    <label class="control-label col-sm-2" for="name">Name:</label>
                    <div class="col-sm-7">
                        <input type="text" value="{{$bank->name}}" class="form-control"  placeholder="Enter name" name="name">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="description">Description:</label>
                    <div class="col-sm-7">
                        <textarea class="form-control" rows="3" placeholder="Enter description..." name="description" >{{$bank->description}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <textarea class="form-control" rows="3" placeholder="Enter corporate address..." name="corporate_address" >{{$bank->corporate_address}}</textarea>
                        {{--<input type="password"  id="pwd" placeholder="Enter password" name="pwd">--}}
                    </div>
                </div>
